...
<script>
    ...
    import iHeaderCollapse from './header-collapse-user';
    import iHeaderMenu from './header-menu';
    ...
    export default {
        name: 'BasicLayout',
        components: { iMenuHead, iMenuSide, iCopyright, iHeaderMenu, iHeaderLogo, iHeaderCollapse, iHeaderReload, iHeaderBreadcrumb, iHeaderSearch, iHeaderUser, iHeaderI18n, iHeaderLog, iHeaderFullscreen, iHeaderSetting, iHeaderNotice, iTabs },
        data () {
            return {
                showDrawer: false,
                ticking: false,
